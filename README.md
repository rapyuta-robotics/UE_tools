...
## Prerequisites
Install ros2 version for your ubuntu distribution.[source](https://docs.ros.org/en/humble/Installation/Ubuntu-Development-Setup.html) 
## BuildROS2

Generated lib and header files are used inside UnrealEngine project, mainly by [rclUE](https://github.com/rapyuta-robotics/rclUE).
...
- **build_and_install_ros2_base.py**:
    ...
    Build ros2 humble from source with patches and copy lib and header files to UnrealEngine project folder.
    ...
    \* This script will modify local ros2 installation. Need to `sudo apt install ros-humble-desktop` if you want to use standard ros2 foxy. todo: build inside docker to avoid affecting local setup.
...
- **build_and_install_ros2_pkgs.py**:
    ...
    Build ros2 humble package inside **ros2_ws** which is created by `build_and_install_ros2_pkgs.py` and copy lib and header files to UnrealEngine project folder. This is mainly used to add/update new msgs to UnrealEngine project.
...
\* Ignores message types deprecated in humble.
