...
Cpp files generated by this script go into:
- `Source/rclUE/Public/Actions/`
- `Source/rclUE/Public/Msgs/`
- `Source/rclUE/Public/Srvs/`

Furthermore, the package folders containing headers and libraries need to be copied into `Source/ThirdParty/ros2lib/`

Please check the corresponding folders in the rclUE Plugin to see how other autogenerated files are handled.
